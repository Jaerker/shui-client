...
const LoadingSpinner = () => {
    ...
    return (
        <section className={`fixed top-20 left-0 w-full h-dvh flex justify-center items-center pointer-events-none transition-all duration-150 ${isLoading ? 'opacity-1' : 'opacity-0'}`}>
